...
* Simple Linear Regression
    + Single predictor, single quantitative response
* Multiple Linear Regression
    + Multiple predictors, single quantitative response
* Predictors can be quantitative or qualitative
    + Create dummy variables for qualitative predictors
